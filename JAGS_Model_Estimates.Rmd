...
### Pullinn the estimates from the Bayesian models.
...
```{r}
dir.create(here::here("Regression_fits"))

pdf("Regression_fits/fit_ind_country_model.pdf",
    width = 12,
    height = 9)
...
```{r}
pdf("Regression_fits/fit_country_model.pdf",
    width = 12,
    height = 9)
ggplot(Pisa_Europe_Data, aes(x=year_orig, y=math))+ 
  geom_point()+
...
```{r}
pdf("Regression_fits/fit_region_model.pdf",
    width = 12,
    height = 9)
...
```{r}
pdf("Regression_fits/fit_income_model.pdf",
    width = 12,
    height = 9) 
...
```{r}
pdf("Regression_fits/fit_incomeregion_model.pdf",
    width = 12,
    height = 9)
