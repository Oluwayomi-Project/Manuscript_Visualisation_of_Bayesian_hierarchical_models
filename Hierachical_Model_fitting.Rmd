...
CountryInd_BRMSModel <- brms::brm(
  brms::bf(math ~ year_orig + (1 ||Country), weights = 1/sigma^2),
...
Country_BRMSModel <- brms::brm(
  brms::bf(math ~ year_orig + (1 + year_orig||Country), weights = 1/sigma^2),
  data = Pisa_Europe_Data,
  iter = 6000, 
  prior = Priors,
  control = list(adapt_delta = 0.93),
...
Region_BRMSModel <- brms::brm(
  brms::bf(math ~ year_orig + (1 + year_orig||Region)+ 
             (1 + year_orig||Country), weights = 1/sigma^2),
  data = Pisa_Europe_Data,
  iter = 6000, 
  prior = Priors,
...
Income_BRMSModel <- brms::brm(
  brms::bf(math ~ year_orig + (1 + year_orig||Income)+ 
             (1 + year_orig||Country), weights = 1/sigma^2),
  data = Pisa_Europe_Data,
  iter = 6000, 
  prior = Priors,
...
IncomeRegion_BRMSModel <- brms::brm(
  brms::bf(math ~ year_orig + (1 + year_orig||Income_Region)+
             (1 + year_orig||Country), weights = 1/sigma^2),
  data = Pisa_Europe_Data,
  iter = 6000, 
  prior = Priors,
