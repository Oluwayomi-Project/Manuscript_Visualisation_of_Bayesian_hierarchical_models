...
#Creating directory to store all the results.
if (!dir.exists(here::here("Results")))
 dir.create(here::here("Results"))

CountryInd_RESULTS <- here::here("Results", "CountryInd_Results.Rdata")
Country_RESULTS <- here::here("Results", "Country_Results.Rdata")
Region_RESULTS  <- here::here("Results", "Region_Results.Rdata")
Income_RESULTS  <- here::here("Results", "Income_Results.Rdata")
IR_RESULTS  <- here::here("Results", "IR_Results.Rdata")
```
...
save(CountryInd_IS, CountryInd_Int_Est, CountryInd_Slop_Est, file= CountryInd_RESULTS)
```
...
#Saving the results
save(Country_IS,Country_Int_est,Country_Slop_est,Country_Int_Est,Country_Slop_Est,
     file= Country_RESULTS)
```
...
#Saving the results
save(Region_IS,Rcountry_IS,Region_IS_Est, Rcountry_IS_Est,
     Region_Int_est,Region_Slop_est,Region_Int_Est,Region_Slop_Est,
     file= Region_RESULTS)
```
...
save(Income_IS,Icountry_IS,INCOME_IS_EST ,Income_IS_Est,
  Income_Int_est,Income_Slop_est,Income_Int_Est, Income_Slop_Est,
     file= Income_RESULTS)
```
...
#Storing the results
save(IncomeRegion_IS,IRcountry_IS,IncomeRegion_Int_est,
     IncomeRegion_Slop_est,Income_Region_Int_Est, Income_Region_Slop_Est,
     file= IR_RESULTS)
```
